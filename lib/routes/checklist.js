...
module.exports = function (app, dbs) {
    ...
    app.post('/updateChecklist', [check("addItem").isLength({ min: 5 }).isLength({ max: 100 }).trim(), check("addDescription").isLength({ max: 256 }).trim(), check("todoSecret").isLength({ min: 2 })], (req, res) => {
